...
function configuredCopy(role: 'primary' | 'replica', order: number, suffix: number): ConfiguredObjectReadProviderCopySnapshot {
...
function snapshot(configuredCopies: readonly Readonly<ConfiguredObjectReadProviderCopySnapshot>[]): ObjectReadDeliverySnapshot {
